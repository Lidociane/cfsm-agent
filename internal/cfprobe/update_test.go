...
func TestUpdateAssetDownloadURL(t *testing.T) {
	...
	want := "https://github.com/Lidociane/cfsm-agent/releases/download/v1.2.3/cf-probe-linux-amd64"
	if got != want {
...
func TestUpdateAssetDownloadURLAppliesProxy(t *testing.T) {
	...
	want := "https://gh-proxy.example.com/https://github.com/Lidociane/cfsm-agent/releases/download/v1.2.3/cf-probe-linux-amd64"
	if got != want {
